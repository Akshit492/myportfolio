...
const submitForm=async(e)=>{
  ...
  return (
    <div className="main-container fade-in" id={props.id || ""}>
      <ScreenHeading subHeading={"Let's Have A Chat"} title={"Contact Me"} />
      <div className="central-form">
        <div className="col">
          <h2 className="title">
            {" "}
            <Typical loop={Infinity} steps={["Get In Touch 📧", 1000, "Let's Learn Together 📖",1000]} />  
          </h2>
          <a
            href="https://sites.google.com/view/akshitsingla/home"
            target="_blank"
          >
            ...
            <div className="img-back">
               ...
               <form onSubmit={submitForm}>
                   ...
                   <div className="send-btn">
                     ...
                     <img src={load1} alt='weak internet'/>
                     </b>):("")}
                       </button>
                       </div>
               </form>
